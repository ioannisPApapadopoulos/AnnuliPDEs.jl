...
###
function collect_errors(TFZρ::Tuple{<:Any, <:Fourier, <:TV}, Xu::Tuple{Matrix{TV}, ModalTrav{TV, Matrix{TV}}}, ua::Function, errors=[]) where TV
...
# helper
function collect_errors(TFαρ::Tuple{<:Any, <:Fourier, <:TV, <:TV}, X::AbstractMatrix, ua::Function, errors=[]) where TV
...
function collect_errors(ZTFαρ::Tuple, uX::Tuple{ModalTrav{TV, Matrix{TV}}, Matrix{TV}}, ua::Function, errors=[]) where TV

    (Z, T, F, α, ρ) = ZTFαρ
    (u, X) = uX

    err1 = collect_errors((T, F, α, ρ), X, ua, [], 0)
